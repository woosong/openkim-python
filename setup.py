...
setup (name = 'kimservice',
    ...
    data_files=[('kim_virial_template', ['virial/virial.c', 'virial/virial.h', 'virial/virial.i','virial/setup.py']),
        ('kim_tests', ['tests/test_python_openkim.kim','tests/test_python_openkim.py',
        'tests/test_python_openkim_neigh.kim','tests/test_python_openkim_neigh.py',
        'tests/test_python_openkim_virial.kim','tests/test_python_openkim_virial.py'])],
    )
